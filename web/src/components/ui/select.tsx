  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[size=default]:h-10 data-[size=sm]:h-8 data-[size=sm]:rounded-md data-[size=sm]:text-[13px]",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-md py-1.5 pr-8 pl-2.5 text-[13.5px] outline-hidden select-none transition-colors",
